...
// Template Casamento — "Nosso Sim". Visual elegante (marfim/dourado).
export function NossoSim({ content, photos }: TemplateProps) {
  ...
  return (
    <div className="min-h-screen bg-stone-50 text-stone-800">
      <header className="px-6 py-16 text-center">
        <p className="text-sm uppercase tracking-[0.35em] text-[#C6A15B]">Nosso sim</p>
        ...
        {content.message && (
          <BlurFade>
            <section className="mt-12 rounded-3xl border border-stone-200 bg-white p-8 shadow-sm">
              <p className="whitespace-pre-line text-center font-serif text-lg leading-8">{content.message}</p>
            </section>
          </BlurFade>
        )}
